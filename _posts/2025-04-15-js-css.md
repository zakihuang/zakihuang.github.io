---
layout: post
title: "JS 与 CSS 是否阻塞 DOM 的渲染和解析"
date: 2025-04-15
categories: [css, js]
tags: [js, css]
---
...
![在这里插入图片描述](/assets/images/d148f693ca21439a868aca2627289e31~tplv-k3u1fbpfcp-zoom-in-crop-mark_1512_0_0_0.awebp.gif)
...
![在这里插入图片描述](/assets/images/ed84300752c543ecb7bb4cf063e7e7a8~tplv-k3u1fbpfcp-zoom-in-crop-mark_1512_0_0_0.awebp.gif)
...
![在这里插入图片描述](/assets/images/50fbe6302d054b0d8491fd8344f42f99~tplv-k3u1fbpfcp-zoom-in-crop-mark_1512_0_0_0.awebp.gif)
...
![在这里插入图片描述](/assets/images/6d5dd223d4bd4860a1b6786da8c87e53~tplv-k3u1fbpfcp-zoom-in-crop-mark_1512_0_0_0.awebp.gif)
...
![在这里插入图片描述](/assets/images/a910002ac79e4f03ad3f73b167a7c4d4~tplv-k3u1fbpfcp-zoom-in-crop-mark_1512_0_0_0.awebp.gif)

再来看看`Firefox`浏览器下的表现。

![在这里插入图片描述](/assets/images/8fe9421ba5714ce7b49d43c3521421d0~tplv-k3u1fbpfcp-zoom-in-crop-mark_1512_0_0_0.awebp.gif)

接着再来看看`Opera`浏览器下的表现。

![在这里插入图片描述](/assets/images/7acd07876d6f4cd4a9041bfd3816db1f~tplv-k3u1fbpfcp-zoom-in-crop-mark_1512_0_0_0.awebp.gif)

`IE11`及以下浏览器的表现。

![在这里插入图片描述](/assets/images/ddc1d198fbca49a6ba3bf1bf344239da~tplv-k3u1fbpfcp-zoom-in-crop-mark_1512_0_0_0.awebp.gif)

`Edge`浏览器下的表现。

![在这里插入图片描述](/assets/images/886d188a2af149ff8c1ac60f7f9eb8d3~tplv-k3u1fbpfcp-zoom-in-crop-mark_1512_0_0_0.awebp.gif)

怎么样，蒙了吧，`5`种浏览器`3`种表现形式，并且没有一种表现与预先分析的一致。

| 浏览器   | 阻塞解析 | 阻塞渲染 | DOMContentLoaded 执行时间点 |
|----------|----------|----------|-----------------------------|
| chrome   | 是       | 是       | 解析后执行                  |
| opera    | 是       | 是       | 解析后执行                  |
| ie11     | 是       | 是       | 解析后执行                  |
...
其实造成这种差异的原因，是一种被称为浏览器样式闪烁（[FOUC](https://link.juejin.cn/?target=https%3A%2F%2Fwebkit.org%2Fblog%2F66%2Fthe-fouc-problem%2F "https://webkit.org/blog/66/the-fouc-problem/")，`Flash of Unstyled Content`）的现象。
